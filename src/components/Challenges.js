    ...
    <section className="challenges">
      ...
      <div className="challenge">
        <div className="challenge-content">
          ...
          <img src=".styles/images/plank.jpg" alt="Plank Challenge" />
      ...
      <div className="challenge">
        <div className="challenge-content">
          ...
          <img src=".styles/images/running.jpg" alt="Running Challenge" />
      ...
      <div className="challenge">
        <div className="challenge-content">
          ...
          <img src=".styles/images/yoga.jpg" alt="Yoga Challenge" />
